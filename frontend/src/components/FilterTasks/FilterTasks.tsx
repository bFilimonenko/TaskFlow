...
export const FilterTasks = ({ submitCallback }: { submitCallback: () => void }) => {
  ...
  const selectedEmployeesOptions: Option[] | undefined = useMemo(
    () =>
  ...
  return (
    <Formik<IFilterForm> initialValues={taskFilters} onSubmit={handleSubmit}>
      {({ setFieldValue, resetForm, values }) => (
        <Form>
          <ScrollArea className="h-[400px] border border-blue-200 rounded-sm">
            <div className="grid gap-5 items-center mb-4 p-3">
